...
export const BLOG_POST_KEYWORDS: Record<string, string[]> = {
  ...
  "advanced-strength-training-for-runners": [
    ...
    "high load strength running economy",
    "single leg strength for runners",
    "running economy strength training meta analysis",
  ],
  "running-vs-biking": [
  ...
  "hitting-the-wall-marathon": [
    ...
    "how to avoid hitting the wall marathon",
    "marathon glycogen depletion",
    "marathon carbohydrate fueling during race",
    "bonking marathon causes and fixes",
    "carb loading before marathon",
  ],
  "weight-training-bone-structure-runners": [
    "weight training bone density runners",
    "how strength training strengthens bones",
    "resistance training bone mineral density",
    "does lifting weights help runners bones",
    "strength training prevent stress fractures",
    "Wolff law running bone adaptation",
    "weight bearing exercise bone health",
  ],
  "yoga-between-runs": [
    "yoga for runners between runs",
    "does yoga help runners recover",
    "yoga flexibility balance runners",
    "cross training yoga running",
    "yoga on rest days running",
    "mindfulness yoga anxiety runners",
    "should runners do yoga",
  ],
  "cycling-between-runs": [
    "cycling between runs cross training",
    "can cycling replace easy runs",
    "bike cross training for runners",
    "cycling VO2max runners research",
    "spin bike recovery day running",
    "should runners cycle on rest days",
    "low impact cross training running",
  ],
  "weight-yoga-cycling-between-runs": [
    "weight training yoga cycling between runs",
    "best cross training for runners research",
    "strength yoga bike recovery days",
    "what to do between hard runs",
    "cross training week for runners",
    "low impact recovery running plan",
    "should runners lift yoga and cycle",
  ],
  "why-sleep-matters-most-runners": [
    "why sleep matters for runners",
    "sleep deprivation running performance",
    "runners ignore sleep recovery",
    "how to prioritize sleep training",
    "sleep injury risk athletes research",
    "best recovery for runners sleep",
    "sleep extension athletic performance",
  ],
  "runners-gi-distress": [
    "runners diarrhea causes",
    "side stitch running fix",
    "gut training endurance runners",
    "GI distress race day running",
  ],
  "gait-analysis-when-to-get": [
    "do I need gait analysis",
    "running form self check",
    "when to get running gait analysis",
  ],
  "periodization-beginners-base-build-peak-taper": [
    "base build peak taper beginners",
    "periodization for beginner runners",
    "training phases running plan",
  ],
  "return-to-run-after-illness": [
    "return to running after cold",
    "running after COVID guidelines",
    "when to run after fever",
  ],
  "cross-training-swim-elliptical-aqua-jog": [
    "aqua jogging for injured runners",
    "elliptical cross training running",
    "swim cross training runners",
  ],
  "black-toenails-runners": [
    "black toenails from running",
    "subungual hematoma runners",
    "prevent black toenails downhill",
  ],
  "hamstring-calf-hip-flexor-runners": [
    "hamstring strain runners",
    "calf strain running recovery",
    "hip flexor pain running",
  ],
  "caffeine-alcohol-training-runners": [
    "caffeine before running research",
    "alcohol and running recovery",
    "ISSN caffeine dose runners",
  ],
  "vacation-travel-training-runners": [
    "running on vacation training",
    "hotel treadmill running plan",
    "jet lag running training",
  ],
  "negative-splits-race-pacing": [
    "negative splits race strategy",
