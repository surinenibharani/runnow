    ...
    sections: [
      {
        paragraphs: [
          ...
          "This article is what I learned from my own flare-up: how it happened, what didn't help, and the slow rehab path that actually worked — **air skipping → heel raises → eccentric heel lowers**. **It's not medical advice. If your Achilles hurts, see a sports medicine doctor or physical therapist** — a clinician may order phases differently for *your* tendon. But if you're a runner trying to understand one workable pattern, this might save you a few frustrated months.",
        ],
      },
      {
        ...
        list: [
          ...
          "Later lesson: a new carbon-plated race shoe (Alphafly 3) could re-irritate the same tendon even after rehab — see below",
        ],
      },
      {
      ...
      {
        id: "phase-1-air-skipping",
        heading: "Phase 1: Air skipping",
        paragraphs: [
          "I started here — not with heavy heel drops. Air skipping is the motion of jumping rope without a rope, or very small hops in place with minimal ground contact. It's a gentle plyometric: the Achilles stores and releases a little elastic energy without the full impact of bounding, sprinting, or long downhill miles.",
          "For me, light springy contact woke the tendon up without the grinding of slow, heavy loading on day one. I stayed tiny and quiet: soft surface, short sets, no hero height. If a hop felt sharp, I stopped — dull \"working\" tension was OK; a stab or limp was not.",
          "When air skipping stayed quiet for several sessions — no next-morning revenge stiffness — I moved to slower strength work. Skipping didn't replace a full rehab plan; it was the entry door that proved the tendon could tolerate a little bounce again.",
        ],
        list: [
          "Start on grass, track infield, or a gym mat — not concrete",
          ...
          "Progress only when skipping stays symptom-stable for several days",
        ],
      },
      {
        id: "phase-2-heel-raises",
        heading: "Phase 2: Heel raises",
        paragraphs: [
          "Next came regular heel raises (calf raises) on flat ground — both feet, hands on a wall for balance, rising onto the toes and lowering with control. No bouncing. No max weight. The goal was to load the calf–Achilles unit through a full range without the extra demand of dropping the heel below the step yet.",
          "I kept the same pain rule: mild tension at the familiar spot was acceptable; wincing, limping, or worse morning stiffness the next day meant I'd jumped ahead.",
        ],
        list: [
          "2–3 sets of 12–15 slow raises, both legs, flat ground, every other day at first",
          "Rise in 1–2 seconds; lower in 2–3 seconds — no bounce at the top",
          "Pain rule: no worse pain during the set; no spike in morning stiffness next day",
          "If a session flares you up, return to air skipping for a few days — progression isn't linear",
          "Single-leg heel raises only when double-leg feels boring, not painful",
        ],
        cta: {
      ...
      {
        id: "phase-3-eccentric-heel-lowers",
        heading: "Phase 3: Eccentric heel lowers",
        paragraphs: [
          "Last came the classic step work: balls of both feet on the edge of a step, heels hanging off. Rise with both legs, then **lower slowly on the affected side** (both up, injured leg down on the eccentric). That's the heavy-slow lowering idea many clinics use — tendons often respond well to controlled lengthening under load once they've tolerated lighter spring and flat raises.",
          "I treated this as the hardest phase, not the first. Dropping the heel below parallel adds demand. If eccentrics flared me, I backed up to flat heel raises and air skipping until mornings calmed again. When eccentric lowers stayed quiet for about a week, I layered easy jog intervals back in — walk-run before continuous miles.",
        ],
        list: [
          "Both legs rise; slow 3-count lower on the affected leg (or both if you're not ready for single-leg)",
          "Start with 2–3 sets of 8–12; build toward 3 sets of 15 as tolerated",
          "Once or twice daily only if mornings stay calm — quality beats volume",
          "Stop or regress if you get a sharp pull, limp, or next-day stiffness spike",
          "Graduate to easy running only after skipping, heel raises, and eccentric lowers all stay stable",
        ],
      },
      {
        id: "alphafly-3",
        heading: "I also stopped using the Nike Alphafly 3",
        paragraphs: [
          "Rehab fixed the tendon load capacity. Footwear still mattered. After that Achilles flare, I **stopped using the Nike Alphafly 3** — a carbon-plated \"super shoe\" — even though I'd raced a prior season in the **Alphafly 2** with no Achilles trouble.",
          "Short version of what happened: the Alphafly 3 irritated the mid-portion Achilles after only a few runs. I rested about **three weeks**, stayed off that shoe, and rebuilt with **air skipping → heel raises → eccentric heel lowers**. Once healthy again I finished **several half marathons and a full marathon** without that pattern coming back — still avoiding the Alphafly 3. Later I retested it on a **9-mile run**; the little mid-Achilles soreness returned. That was enough: same brand line, new geometry, different load on *my* tendon.",
          "This is one runner's n=1, not a verdict that Alphafly 3 injures everyone. The point is simpler — **rehab without removing a shoe that keeps poking the same spot is an incomplete plan.** Full story and the broader supershoe caveats: [Why super shoes are not for everybody](/blog/why-super-shoes-not-for-everybody).",
        ],
        list: [
          "Loved last year's racer? Still treat this year's update like a new shoe",
          "If a model repeatedly lights up the mid-Achilles, retire it for racing and training",
          "Daily trainers that feel stable beat a plate that wins Instagram",
        ],
        cta: {
          text: "Read the super shoes deep dive",
          href: "/blog/why-super-shoes-not-for-everybody",
        },
      },
      {
        id: "returning",
        ...
        list: [
          "Cap weekly mileage increase at ~10% — yes, even for veterans (a guideline, not a law)",
          ...
          "Replace worn shoes before the heel stack is dead — and drop race shoes that keep re-irritating the Achilles ([super shoes aren't for everybody](/blog/why-super-shoes-not-for-everybody))",
          "Keep air skipping + heel raises + occasional eccentric lowers in maintenance — 2× per week even when healthy",
          "Treat morning stiffness as data, not something to run off",
        ],
        paragraphs: [
          "I got back to normal training, but I didn't forget the lesson. Experience doesn't grant immunity from load errors — or from a model-year geometry change that doesn't agree with your tendon. Tendons are patient creditors — they always collect.",
        ],
        cta: {
          text: "Injury prevention basics",
          href: "/blog/avoiding-injuries",
